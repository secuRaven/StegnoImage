    ...
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-gray-950 text-gray-200' : 'bg-gray-50 text-gray-800'}`}>
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          {activeSection === AppSection.ENCODE && (
            <EncodeSection isDarkMode={isDarkMode} />
          )}
          
          {activeSection === AppSection.DECODE && (
            <DecodeSection isDarkMode={isDarkMode} />
          )}
          ...
          {activeSection === AppSection.INFO && (
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-900' : 'bg-white'} shadow-md`}>
              ...
              <div className={`prose ${isDarkMode ? 'prose-invert' : ''} max-w-none`}>
                <p>
                  <strong>Steganography</strong> is the practice of hiding secret information within ordinary, non-secret data or a physical object to avoid detection.
                </p>
                
                <h3>How It Works</h3>
                <p>
                  StegoCrypt uses the Least Significant Bit (LSB) technique to hide your message inside an image. This works by replacing the least significant bit of each color channel (RGB) with bits from your message.
                </p>
